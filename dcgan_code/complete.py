...
parser.add_argument('--checkpointDir', type=str, default='/Users/Joe/Desktop/gp/Application_GUI/dcgan_code/checkpoints/celebA_checkpoint')
parser.add_argument('--outDir', type=str, default='/Users/Joe/Desktop/gp/Application_GUI/dcgan_code/output')
parser.add_argument('--outInterval', type=int, default=1000)
parser.add_argument('--maskType', type=str,
                    choices=['random', 'center', 'left', 'full', 'grid', 'lowres', 'custom'],
                    default='center')
parser.add_argument('--customMask', type=str, default='')
